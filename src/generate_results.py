...
name = '../results/detfps60fd2normalpersonplusballinterval/'
...
num_out, person, ball, cor_person, cor_ball = getpoints()

frame_from_int = overlapping_interval(person,ball,cor_person,cor_ball)
while cap.isOpened():
